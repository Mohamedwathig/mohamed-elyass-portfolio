...
return (
        <div id="services" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">Front-End Developer from Sudan with 3+ years of experience building responsive, scalable web applications using React, Vite, and Tailwind CSS. Skilled in designing clean UI/UX, developing reusable components, integrating RESTful APIs, and creating dynamic dashboards and data-driven interfaces.

Additionally experienced in Machine Learning and AI research, applying intelligent models to real-world problems including cybersecurity and phishing detection. Passionate about delivering high-quality digital products, optimizing performance, and continuously improving through hands-on projects and research-driven development.</p>
